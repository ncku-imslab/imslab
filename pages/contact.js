    ...
    <Row className='block' key='contact'>
      ...
      <Col md={8}>
        ...
        <Row>
          ...
          <Col md={10}>
            {data.address}<br />
            (<a href='https://www.google.com/maps/dir//22.9975457,120.2213674/@22.99731,120.221694,16z/data=!4m3!4m2!1m0!1m0?hl=zh-TW'
              target='_blank' rel="noopener noreferrer">Google {data.nav}</a>)<br />
          </Col>
        </Row>
      </Col>
...
Contact.propTypes = {router: PropTypes.object.isRequired};
